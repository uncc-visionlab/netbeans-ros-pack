...
@Messages({
    "LBL_Cfg_LOADER=ROS Dynamic Reconfigure File"
})
@MIMEResolver.ExtensionRegistration(
        displayName = "#LBL_Cfg_LOADER",
...
@ActionReferences({
    @ActionReference(
            path = "Loaders/text/x-ros-python/Actions",
...
public class CfgDataObject extends MultiDataObject {
    ...
    public CfgDataObject(FileObject pf, MultiFileLoader loader) throws DataObjectExistsException, IOException {
        super(pf, loader);
        registerEditor("text/x-ros-python", true);
    }
    ...
    @Messages("LBL_Cfg_EDITOR=Source")

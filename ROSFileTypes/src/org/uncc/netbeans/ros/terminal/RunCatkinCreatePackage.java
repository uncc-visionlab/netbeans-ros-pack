...
public class RunCatkinCreatePackage extends TerminalDriverAction {
    ...
    public RunCatkinCreatePackage(Project project, String packageName,
            String dependenciesStr) {
        this.project = project;
//        String rosRoot = project.getProperty(Project.ROS_ROOTFOLDER_PROPERTYNAME);
//        String ros_ws = project.getProperty(Project.ROS_WORKSPACEFOLDER_PROPERTYNAME);
//        String ros_src = project.getProperty(Project.ROS_SOURCEFOLDER_PROPERTYNAME);

...
public class MyTerminalSupportImpl {
     ...
     * @param io io will be reused if this value is not null, if null the new
     * one will be created
     ...
     * @param pwdFlag try to set title to 'user@host - ${PWD}' every time ${PWD}
     * changes.
     */
